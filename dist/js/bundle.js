...
var accordion = function accordion(trigerSelector, itemsSelector) {
...
var forms = function forms() {
  ...
  var clearInouts = function clearInouts() {
...
var modals = function modals() {
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      if (!btnPressed && document.documentElement.clientHeight + window.scrollY >= document.documentElement.scrollHeight) {
        document.querySelector(selector).click();
      }
    });
  }
...
/***/ "./src/js/modules/moreStyleLoad.js":
/*!*****************************************!*\
  !*** ./src/js/modules/moreStyleLoad.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function moreStyleLoad(triggerSelector, wrapper) {
  var triggerDel = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  ...
  trigger.addEventListener('click', function () {
    ...
    (0,_services_requests__WEBPACK_IMPORTED_MODULE_5__.getResourse)('db.json')
  ...
  function createCards(response) {
    response.forEach(function (_ref) {
      ...
      card.classList.add('col-sm-3', 'col-sm-offset-0', 'col-xs-10', 'col-xs-offset-1', 'animate__animated', 'animate__backInDown');
      card.innerHTML = "\n      <div class='styles-block'>\n        <img src= ".concat(src, " alt='style'>\n        <h4>").concat(title, "</h4>\n        <a href=").concat(link, ">\u041F\u043E\u0434\u0440\u043E\u0431\u043D\u0435\u0435</a>\n      </div>");
      document.querySelector(wrapper).appendChild(card);
    });
  }
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (moreStyleLoad);

/***/ }),

/***/ "./src/js/modules/picturesSizes.js":
/*!*****************************************!*\
  !*** ./src/js/modules/picturesSizes.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function picturesSizes(imgSelector) {
  ...
  function showImg(block) {
    ...
    block.querySelector('.sizes-hit').style.backgroundImage = 'linear-gradient(66deg,#a12ab1 0,#c818bc 100%)';
  }
  function hideImg(block) {
    ...
    block.querySelector('.sizes-hit').style.backgroundImage = 'linear-gradient(66deg,#ed8c00 0,#f99300 100%)';
  }
  blocks.forEach(function (block) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (picturesSizes);
...
/*!**************************!*\
  ...
  \**************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_moreStyleLoad__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/moreStyleLoad */ "./src/js/modules/moreStyleLoad.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_moreStyleLoad__WEBPACK_IMPORTED_MODULE_0__["default"])('.button-styles', '#styles .row', true);
  (0,_modules_sliders__WEBPACK_IMPORTED_MODULE_2__["default"])('.main-slider-item', 'vertical');
  (0,_modules_sliders__WEBPACK_IMPORTED_MODULE_2__["default"])('.feedback-slider-item', 'horizontal', '.main-prev-btn', '.main-next-btn');
